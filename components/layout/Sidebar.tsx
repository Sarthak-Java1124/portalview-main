  ...
  return (
    ...
    >
      <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "1.125rem 0.875rem", gap: 4 }}>
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "var(--line)", margin: "0.25rem 0 0.5rem" }} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span
              className="dot-pulse"
              style={{ background: status === "ready" ? "var(--ok)" : status === "connecting" ? "var(--warn)" : "var(--ink-4)", color: status === "ready" ? "var(--ok)" : "var(--warn)" }}
            />
            <span style={{ fontSize: ".6rem", letterSpacing: ".06em", textTransform: "uppercase", fontWeight: 600, color: "var(--ink-4)", fontFamily: "var(--font-mono, monospace)" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: ".66rem" }}>
            ...
            <span style={{ fontFamily: "var(--font-mono, monospace)", color: "var(--ink-2)", fontVariantNumeric: "tabular-nums" }}>#4,182,907</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: ".66rem" }}>
            <span style={{ color: "var(--ink-4)" }}>Gas</span>
            <span style={{ fontFamily: "var(--font-mono, monospace)", color: "var(--ink-2)" }}>0.024 POT</span>
          </div>
        </div>
        ...
        <button
          ...
          style={{
            ...
            padding: "0.5rem 0.625rem",
            background: isConnected ? "var(--accent)" : "var(--background)",
        ...
        >
          <span
            className="avatar"
            style={{ width: 26, height: 26, fontSize: ".58rem" }}
          >
            {initials}
          </span>
          <div style={{ display: "flex", flexDirection: "column", gap: 1, flex: 1, minWidth: 0 }}>
            <span style={{ fontFamily: "var(--font-mono, monospace)", fontSize: ".74rem", fontWeight: 600, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              {isConnected ? formatAddress(selectedAccount?.address ?? "") : "Not connected"}
            </span>
            <span style={{ fontFamily: "var(--font-mono, monospace)", fontSize: ".64rem", color: "var(--ink-2)" }}>
              {isConnected ? "Connected" : "Connect to start"}
            </span>
          </div>
        </button>
      </div>
